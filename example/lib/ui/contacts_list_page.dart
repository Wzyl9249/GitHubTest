...
class _ContactListPageState extends State<ContactListPage> {
  ...
  Widget build(BuildContext context) {
    return AzListView(
      ...
      indexBarData: SuspensionUtil.getTagIndexList(_contacts),//缩短索引
      indexHintBuilder: (context, hint) {
        return Container(
          ...
          child:
              Text(hint, style: TextStyle(color: Colors.pink, fontSize: 30.0)),
        );
      },
      indexBarMargin: EdgeInsets.all(10),
      indexBarOptions: IndexBarOptions(
        needRebuild: true,
        decoration: getIndexBarDecoration(Colors.purple!), // 正常颜色
        downDecoration: getIndexBarDecoration(Colors.red!),//按下颜色
      ),
    );
  }
}
